...
export default function Services() {
  return (
    <PageShell
      ...
      description="Comprehensive elder care solutions designed to meet every need."
    >
        ...
        <section className="max-w-6xl mx-auto py-10 px-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="card p-6 flex flex-col">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Link
                href="/book/service/medical-support"
                className="ml-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold flex items-center justify-center gap-2"
              >
                Book Now
              </Link>
            </div>
          ...
          <div className="card p-6 flex flex-col">
            ...
            <p className="text-gray-700 text-sm mb-2">
              Comprehensive support for daily living activities including
              personal care, meals, and household tasks.
            </p>
            <div className="mb-2">
              <div className="font-semibold text-gray-800 text-sm mb-1">
                What&apos;s Included:
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Link
                href="/book/service/daily-assistance"
                className="ml-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold flex items-center justify-center gap-2"
              >
                Book Now
              </Link>
          ...
          <div className="card p-6 flex flex-col">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Link
                href="/book/service/companionship"
                className="ml-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold flex items-center justify-center gap-2"
              >
                Book Now
              </Link>
          ...
          <div className="card p-6 flex flex-col">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Link
                href="/book/service/specialized-care"
                className="ml-auto bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold flex items-center justify-center gap-2"
              >
                Book Now
              </Link>
        ...
        <section className="w-full py-16 bg-gradient-to-r from-blue-500 to-green-400">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-white/90 mb-8">
              Connect with our care specialists to discuss your specific needs
              and find the perfect care solution.
            </p>
