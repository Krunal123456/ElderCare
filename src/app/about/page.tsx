          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700">
                We believe every elderly person deserves dignified,
                compassionate care, and every family deserves support in their
                caregiving journey.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="card p-6 flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    Every decision we make is guided by empathy and genuine
                    care.
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6 flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    We involve families in care decisions and keep them
                    informed.
                  </div>
                </div>
              </div>
              <div className="card p-6 flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    We continuously strive to exceed expectations in care
                    quality.
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded p-6 text-center shadow"
                >
